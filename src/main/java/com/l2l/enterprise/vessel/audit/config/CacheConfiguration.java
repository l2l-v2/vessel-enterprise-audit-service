...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("VesselAudit");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("VesselAudit");
        ...
        config.getMapConfigs().put("com.l2l.enterprise.vessel.audit.domain.*", initializeDomainMapConfig(jHipsterProperties));
